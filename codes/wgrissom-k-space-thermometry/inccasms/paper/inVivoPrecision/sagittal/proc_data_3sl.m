...
phs = pi;
A = [1 1 1; ...
    exp(1i*phs/2+1i*(sliceMid)*phs/2/sliceGap) exp(1i*(sliceMid)*phs/2/sliceGap) exp(-1i*phs/2+1i*(sliceMid)*phs/2/sliceGap); ...
    exp(1i*phs+1i*(sliceMid)*phs/sliceGap) exp(1i*(sliceMid)*phs/sliceGap) exp(-1i*phs+1i*(sliceMid)*phs/sliceGap)]; % encoding functions
